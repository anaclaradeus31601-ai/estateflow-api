...
export class AmenityController {
  ...
  //depois colocar os guards para verificar as roles dos usuarios, somente usuarios com a role ADMIN podem acessar as rotas de criar, atualizar e deletar amenidades
  @Post()
