  ...
  async register(publicRegisterUserDto: PublicRegisterUserDto) {
    ...
    const user = await this.prisma.user.create({
      data: {
        ...
        birthDate: publicRegisterUserDto.birthDate || null,
        budget: publicRegisterUserDto.budget || null,
        city: publicRegisterUserDto.city || null,
        notes: publicRegisterUserDto.notes || null,
